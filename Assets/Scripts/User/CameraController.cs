...
namespace User
{
    ...
    {
        [Inject]
        public CameraController(CameraControllerFacade facade, CameraSettings settings, InputService inputService, WorldMouseControllerService worldUIControllerService, WindowFactory windowService)
        {
            _facade = facade;
            _settings = settings;
